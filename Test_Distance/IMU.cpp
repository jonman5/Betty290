...
void bubbleSort(float *buffer, int length) {
  int i, j;
...
int getAverage(float *buffer, int length) {
  float sum = 0;
...
float getAccelX() { //return x-acceleration in mm/s^2
  return ((int)9807 *myIMU.ax);
}

float getAccelY() { //return y-acceleration in mm/s^2
  return ((int)9807 *myIMU.ay);
}
